...
#[allow(dead_code)] // SAFETY: App Store gate kept for MAS/iOS builds — used when SOLOMD_APP_STORE_BUILD=1, dead in default dev builds — TODO: wire AI commands to call app_store_disabled (#app-store-gate)
