...
- **ห้ามทำงานบนสาขาหลัก (`main` / `master`) โดยตรง:** ทุกครั้งที่มีการปรับปรุงโค้ด เพิ่มฟีเจอร์ หรือแก้ไขปัญหา ห้ามคอมมิตหรือแก้ไขบนสาขาหลักเด็ดขาด เพื่อรักษาความเสถียรของสาขาหลัก
- **ห้ามแตะสาขา `mirror` เด็ดขาด:** `mirror` คือสำเนา upstream (`zhitongblog/solomd`) แบบ byte-identical ไว้อ่าน diff/sync เท่านั้น — sync ด้วย `git checkout mirror && git reset --hard upstream/main && git push --force-with-lease origin mirror` เมื่อผู้ใช้สั่งเท่านั้น
...
- **ห้าม PR หรือ Merge เข้าสาขาหลักด้วยตนเองเด็ดขาด:** 
  ...
  - **ไม่อนุญาต**ให้เปิด Pull Request (PR) หรือกด Merge เข้าสาขาหลัก (`main` / `master`) เองโดยไม่ได้รับคำสั่งหรืออนุมัติอย่างชัดเจนจากผู้ใช้งาน (Human)

---

## 2. แนวปฏิบัติที่ดีที่สุด (Best Practices)

- **การสื่อสาร:** ใช้ภาษาไทยเป็นหลักในการตอบคำถาม การสรุปงาน และการสื่อสารกับผู้ใช้ อธิบายด้วยภาษาที่เข้าใจง่าย (เว้นแต่มีการระบุเป็นภาษาอังกฤษ)
